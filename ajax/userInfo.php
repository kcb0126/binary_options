...
$marketsSQL = mysqli_query($con, "SELECT * FROM bets WHERE marketid='$marketid'");
...
while($archivedBetsSQL != null // stop looping if there is no result
    && $data = mysqli_fetch_array($archivedBetsSQL, MYSQLI_ASSOC))
{
